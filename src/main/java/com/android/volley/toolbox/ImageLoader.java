...
public class ImageLoader {
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight,
            ScaleType scaleType, final String cacheKey, final Priority priority) {
        return new ImageRequest(requestUrl, new Listener<Bitmap>() {
            @Override
            public void onResponse(Bitmap response) {
                onGetImageSuccess(cacheKey, response);
            }
        }, maxWidth, maxHeight, scaleType, Config.RGB_565, priority, new ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
     ...
     * @param maxWidth The maximum width of the returned image.
     * @param maxHeight The maximum height of the returned image.
     * @param priority Priority to load bitmap
     * @return A container object that contains all of the properties of the request, as well as
     *     the currently available image (default if remote is not loaded).
     */
    public ImageContainer get(String requestUrl, ImageListener imageListener, ScaleType scaleType,
                              int maxWidth, int maxHeight, Priority priority) {
        // only fulfill requests that were initiated from the main thread.
        throwIfNotOnMainThread();
        ...
        Request<?> newRequest =
                new ImageRequest(requestUrl, new Listener<Bitmap>() {
                    ...
                    public void onResponse(Bitmap response) {
                        ...
                        Config.RGB_565, priority, new ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        onGetImageError(cacheKey, error);
                    }
